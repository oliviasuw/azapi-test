...
public class NewCorrectnessTester extends Wizard implements INewWizard {
	ModulePropertiesPage appage;
	AgentZeroProject azp;
	
	public NewCorrectnessTester() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("AgentZero Correctness Tester Creation Wizard.");
	...
	public boolean performFinish() {
		azp.createNewCorrectnessTester(appage.getModuleName(), true);
		return true;		
	}
