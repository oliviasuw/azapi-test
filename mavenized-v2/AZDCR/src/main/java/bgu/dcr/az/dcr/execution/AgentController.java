...
import bgu.dcr.az.dcr.api.modules.MessageRouter;
import bgu.dcr.az.dcr.execution.Context.ContextGenerator;
import bgu.dcr.az.dcr.util.FastSingletonMap;
...
import static bgu.dcr.az.execs.api.experiments.ExecutionEnvironment.async;
import static bgu.dcr.az.execs.api.experiments.ExecutionEnvironment.sync;
...
public abstract class AgentController extends AbstractProc {
    ...
    public AgentController(int id, Execution<?> ex) throws ClassNotFoundException, ConfigurationException, InitializationException {
        super(id);
        this.execution = ex;
    ...
    protected void quota() {
        while (true) {
            ...
            if (m != null) {
                ...
                if (newM != null) {
                    activeAgent.am.handle(activeAgent.a, newM.getName(), newM.getArgs());
                }
    ...
    protected class AgentStateStack {
        ...
        private void restore(boolean shouldPoll) {
            if (shouldPoll) {
                ...
                AgentController.this.activeAgent = null;
