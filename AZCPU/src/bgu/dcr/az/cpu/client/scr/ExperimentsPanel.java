...
public class ExperimentsPanel extends Composite implements HasText {
	...
	private void initializeRightClickMenu() {
		...
		MenuItem menuItem1 = new MenuItem("View", true, viewCmd);
	...
	private void openMenu(Event event) {
		...
		if (selected != null) {
			...
			// System.out.println("right is" + right + "CellList width"
			// + cellList.getOffsetWidth() + "cellList left" +
			// cellList.getAbsoluteLeft());
	...
	public void initCellList() {
		...
		// .createCustomManager(new EventTranslator<ExperimentData>() {
		//
		// @Override
		// public boolean clearCurrentSelection(
		// CellPreviewEvent<ExperimentData> event) {
		// // TODO Auto-generated method stub
		// return false;
		// }
		//
