    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        vmetaList.getSelectionModel().getSelectedItems().addListener(new ListChangeListener<VisualizationMetadata>() {
            ...
            public void onChanged(Change<? extends VisualizationMetadata> c) {
                ...
                final VisualizationDrawer<Image, Pane, ?> drawer = meta.getDrawer();
                selectedVisualizationImage.setImage(drawer.getThumbnail());
                currentVisualizationDescription.getEngine().load(drawer.getDescriptionURL());
