...
public class TopDescriptionLayout extends javax.swing.JPanel implements PageView{
    ...
    public void setPage(Page model) {
        List<ParamModel> desc = model.getParamsWithRole(INFO_ROLE);
        List<ParamModel> cont = model.getParamsWithRole(CONTENT_ROLE);
        
        for (ParamModel i : desc) topDescription.add(i.getDefaultView());
