package bgu.dcr.az.ui.components.onoffswitch.skin;

import bgu.dcr.az.ui.components.common.Symbol;
import bgu.dcr.az.ui.components.common.SymbolType;
import bgu.dcr.az.ui.components.common.Util;
...
//            text.setPrefSize(FXUtils.requiredWidthOfLabel(text), height * 0.59375);
            text.relocate(height * 0.125, height * 0.15);
//            text.relocate(FXUtils.requiredWidthOfLabel(text), height * 0.15);
