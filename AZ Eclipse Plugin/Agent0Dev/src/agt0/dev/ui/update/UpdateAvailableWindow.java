...
public class UpdateAvailableWindow extends Dialog {

	/**
	 * Create the dialog.
	 * @param parentShell
	 */
	public UpdateAvailableWindow(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		label.setImage(ResourceManager.getPluginImage("Agent0Dev", "icons/dialogs/big_smile copy.png"));
		...
		lblNewLabel.setText("\r\nFramework update to version " + FrameworkUpdateUnit.UNIT.getLastKnownVersion() + " found\r\ndo you want to update?");
