...
public class bgu_dcr_az_mui_scr_problem_ProblemViewScreen implements ControllerManipulator, RegistrationMarker{
    ...
    static {
        ControllerRegistery.get().register(new bgu_dcr_az_mui_scr_problem_ProblemViewScreen(), "main.pages.problem");
    }
    ...
    public Controller create(BaseController c) {
        Controller cc = bgu.dcr.az.mui.scr.problem.ProblemViewScreen.create(bgu.dcr.az.mui.scr.problem.ProblemViewScreen.class);
    ...
    public String toString() {
        return "bgu.dcr.az.mui.scr.problem.ProblemViewScreen";
    }

    @Override
    public Class controllerClass() {
        return bgu.dcr.az.mui.scr.problem.ProblemViewScreen.class;
    }
