...
public class ListPV extends javax.swing.JPanel implements ParamView {
    ...
    public ListPV() {
        ...
        lst.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                for (FocusListener l : getFocusListeners()) l.focusGained(e);
            }

            @Override
            public void focusLost(FocusEvent e) {
                for (FocusListener l : getFocusListeners()) l.focusLost(e);
            }
    ...
    public void setParam(final BaseParamModel pmodel) {
        configurePopupMenu(pmodel);
        innerModel = new GenericListModel();

        List val = (List) pmodel.getValue();
        ...
        lst.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                pmodel.fireSelectionChanged(lst.getSelectedValue());
            }
        });

        if (!pmodel.getViewHints().dnd().equals(DND.UNDEF)) {
            setDND(pmodel);
        }

        if (pmodel.getViewHints().allowDeleteSelection()) {
            allowDeleteSelection();
        }

        final DefaultListRenderer renderer = new DefaultListRenderer();
        renderer.setModel(pmodel);
