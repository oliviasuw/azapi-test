...
public class bgu_dcr_az_mui_scr_problem_ConstraintCalcConsole implements ControllerManipulator, RegistrationMarker{
    ...
    static {
        ControllerRegistery.get().register(new bgu_dcr_az_mui_scr_problem_ConstraintCalcConsole(), "problem.console");
    }
    ...
    public Controller create(BaseController c) {
        Controller cc = bgu.dcr.az.mui.scr.problem.ConstraintCalcConsole.create(bgu.dcr.az.mui.scr.problem.ConstraintCalcConsole.class);
    ...
    public String toString() {
        return "bgu.dcr.az.mui.scr.problem.ConstraintCalcConsole";
    }

    @Override
    public Class controllerClass() {
        return bgu.dcr.az.mui.scr.problem.ConstraintCalcConsole.class;
    }
