...
public class NewProblemGenerator extends Wizard implements INewWizard {
	ModulePropertiesPage appage;
	AgentZeroProject azp;
	
	public NewProblemGenerator() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("AgentZero Problem Generator Creation Wizard.");
	...
	public boolean performFinish() {
		azp.createNewProblemGenerator(appage.getModuleName(), true);
		return true;		
	}
