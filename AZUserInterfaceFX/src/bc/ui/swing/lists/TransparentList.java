...
public class TransparentList extends javax.swing.JPanel {
    ...
    public void setItems(Collection<Visual> visuals) {
        GenericListModel<Visual> data = new GenericListModel<>();

        if (visuals instanceof LinkedList) {
            data.setInnerList((LinkedList<Visual>) visuals);
        } else {
            data.setInnerList(new LinkedList<>(visuals));
        }
