...
public class DefaultListRenderer extends javax.swing.JPanel implements ListCellRenderer {
    ...
    public void setModel(BaseParamModel model) {
        this.model = model;
    }
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        lbl.setIcon(model.getPage().getModel().provideParamValueIcon(model.getName(), value));
        lbl.setText(value.toString());
        Dimension ps = this.getPreferredSize();
        //this.setPreferredSize(new Dimension(list.getSize().width - 5, ps.height));
        if (model.getViewHints().showDescription()){
            desc.setText(model.getPage().getModel().provideParamValueDescription(model.getName(), value));
        }else {
            desc.setText("");
        }
        if (index % 2 == 0) {
