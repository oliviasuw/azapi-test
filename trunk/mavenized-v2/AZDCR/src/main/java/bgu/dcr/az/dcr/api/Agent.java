...
import static bgu.dcr.az.dcr.Agt0DSL.range;
import bgu.dcr.az.dcr.api.annotations.Algorithm;
import bgu.dcr.az.dcr.api.annotations.WhenReceived;
import bgu.dcr.az.dcr.api.exceptions.InvalidValueException;
import bgu.dcr.az.dcr.api.exceptions.RepeatedCallingException;
...
public abstract class Agent extends Agt0DSL {
    ...
    public final ContinuationMediator exec(Agent agent) {
