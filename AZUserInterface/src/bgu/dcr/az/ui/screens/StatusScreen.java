...
public class StatusScreen extends javax.swing.JPanel {
    ...
    public void setModel(Experiment experiment) {
        visualTests = Visual.adapt(experiment.subExperiments(), new Visual.VisualGen() {
        ...
        testList.addSelectionListner(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (items.isEmpty()) {
                    ...
                    testView.setModel((CPExperimentTest) items.get(0).getItem());
        ...
        final int expLength = experiment.numberOfExecutions();

        mod.setMaximum(expLength);
        progressLabel.setText("Execution 0 " + " of " + expLength);
        ...
        AppController.getEventServer().listeners().add(new ExperimentStatusEventListener() {
            ...
            public void onSubExperimentStarted(String name) {
                for (Visual v : visualTests) {
                    if (((Experiment) v.getItem()).getName().equals(name)) {
            ...
            public void onNumberOfFinishedExecutionsChanged(int numberOfFinishedExecutions) {
                mod.setValue(numberOfFinishedExecutions);
                progressLabel.setText("Execution " + (mod.getValue()) + " of " + expLength);
            }
        });
    ...
    private void initComponents() {
        ...
        testView = new bgu.dcr.az.ui.screens.TestView();
    ...
    private bgu.dcr.az.ui.screens.TestView testView;
