...
public class SingleVariableEditor extends javax.swing.JPanel {
    ...
    public void setModel(Property var) {
        this.var = var;
        this.varDesc.setText(var.doc().description());
        this.varName.setText(var.name());
        this.varVal.setText(var.stringValue());
    }
    ...
    public Object getValue() {
        ...
        Object ret = ReflectionDSL.valueOf(val, var.typeInfo().getType());
        return ret;
    }
