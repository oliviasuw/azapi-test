...
public class TestView extends javax.swing.JPanel {
    ...
    public TestView() {
        ...
        varsGen = new Visual.VisualGen() {
            ...
            public Visual gen(Object it) {
                ...
                return new Visual(it, "<html>+ <b>" + var.name() + "</b>=<b><span color='#d2e9ff'>'" + var.get() + "'</span></b> [ " + var.doc().description() + " ]</html>", "", null);
            }
        };
    }
    ...
    public void setModel(CPExperimentTest r) {
        try {
            Configuration rconf = ConfigurationUtils.createConfigurationFor(r).loadFrom(r);
            testVars.setItems(Visual.adapt(ConfigurationUtils.getAttributesOf(rconf), varsGen));
            pgenVars.setItems(Visual.adapt(ConfigurationUtils.getAttributesOf(ConfigurationUtils.load(r.getProblemGenerator())), varsGen));

            algos.setItems(Visual.adapt(r.getAlgorithms(), new VisualGen() {
