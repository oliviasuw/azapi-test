...
public class PolygonUtils {
	 ...
	 * @param rotAngle
	 *            The rotation angle in <b>radians</b>.
	 * @param centroid
	 *            The centroid of the polygon.
	 * @param original
	 *            When rotating a polygon with a mouse, the original must be
	 *            maintained.
	 */
	 ...
	 * 
	 * @param pg
	 *            The polygon to rotate around it's center of mass. Verticies
	 ...
	 * 
	 * @param pg
	 *            The polygon to test for insideness
	 * @param p
