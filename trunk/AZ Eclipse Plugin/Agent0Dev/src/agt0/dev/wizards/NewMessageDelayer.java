...
public class NewMessageDelayer extends Wizard implements INewWizard {
	ModulePropertiesPage appage;
	AgentZeroProject azp;
	
	public NewMessageDelayer() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("AgentZero Message Delayer Creation Wizard.");
	...
	public boolean performFinish() {
		azp.createNewMessageDelayer(appage.getModuleName(), true);
		return true;		
	}
